...
describe('Testing Retrieve Item', () =>{
    ...
    let retrieveItem = new RetrieveItem('study', 'Name', 'id', '20180101', 'CT', 'Description', 'Accession', 'uid', 'self')
    ...
    it('should set number of Instances', () => {
        ...
        expect(retrieveItem.numberOfInstances).toBe(15)
    })

    it('should set number of Series', () => {
        retrieveItem.setNumberOfSeries(6)
        expect(retrieveItem.numberOfSeries).toBe(6)
    })
