        ...
        return (
            <div className="end">
                <span className="mr-1" hidden={!this.props.roles.anon}>
                    <Link id='anon' ref={refAnon} type="button" className="btn btn-info"
                ...
                <span className="mr-1" hidden={!this.props.roles.export_extern || !this.props.roles.export_local}>
                    <Link id='export' ref={refExport} type="button" className="btn btn-primary"
                ...
                <span className='mr-2' hidden={this.props.apercu}>
                ...
                <span className="mr-2" onMouseOver={this.props.apercu ? () => this.setState({show: ''}) : null}
