                    ...
                    <div className='col-sm'>
                        <div className={'d-flex flex-row justify-content-between'}>
                            ...
                            <Dropdown onClick={this.handleClick}>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item className='bg-primary' onClick={this.sendToExportList}>Export
                                        List</Dropdown.Item>
                                    <Dropdown.Item className='bg-info' onClick={this.sendToAnonList}>Anonymize
                                        List</Dropdown.Item>
                                    <Dropdown.Item className='bg-danger' onClick={this.sendToDeleteList}>Delete
                                        List</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </div>
